        ...
        <footer className="footer">
            <div className="footer-container">
                ...
                <div className="footer-section">
                    <h3 className='one'>Menu</h3>
                    <ul>
                        <li><span className="active">■</span> Home</li>
                        <li><span>■</span> About</li>
                        <li><span>■</span> Jobs</li>
                        <li><span>■</span> Freelancers</li>
                    </ul>
                </div>

                {/* Jobs Section */}
                <div className="footer-section">
                    <h3 className='two'>Jobs</h3>
                    <p>
                ...
                <div className="footer-section">
                    <h3 className="three">Social Link</h3>
                ...
                {/* Newsletter Section */}
                <div className="footer-section">
                    <h3 className='four'>Newsletter</h3>
                    <input type="email" className='input-Footer' placeholder="Enter Your Email" />
